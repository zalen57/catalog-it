...
Lalu demo lewat **XAMPP** (`http://localhost/catalog/dist/`) atau **GitHub Pages** (URL live di [`src/config/siteLinks.js`](./src/config/siteLinks.js)) + tunjukkan **Firestore** berisi koleksi `articles` dan dokumen `users` untuk admin.
